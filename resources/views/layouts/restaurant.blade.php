...
@if(Auth::user()->type=="restuarant")
<a href="{{route('food')}}" >Food Menu</a>
<a  href="{{route('bar')}}">Bar Menu</a>
@endif 
@if(Auth::user()->type=="cafe")
<a  href="{{route('bar')}}">Bar Menu</a>
<a   href="{{route('shisha')}}">Shisha Menu</a>
@endif 
@if(Auth::user()->type=="caferest")
<a href="{{route('food')}}" >Food Menu</a>
<a  href="{{route('bar')}}">Bar Menu</a>
<a   href="{{route('shisha')}}">Shisha Menu</a>
@endif 
...
<a  href="{{route('social')}}">Social Links</a>
